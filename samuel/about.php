...
<table bgcolor="black" align="center" cellpadding="10px">
	<tr><td><h1>About Us</h1>
        <p>
			Sammy's Toys is solely a local store providing online shopping. You can always visit us at our store situated at the stated address. <br/>
			We hope that this site is convenient for surveys as well as shopping. Please do let us know if there is any comment and send it to the email below.<br/>
			If you're not a member yet, please make sure to <span style="background-color:yellow"><a href="signup.php"><strong>&nbsp;sign up&nbsp;</strong></a></span>.
		</p>
	<br/>	
	<h2>Payment Method</h2>
	<img src="images/pay.jpg" alt="Latest Product" width="480" height="200">
		<p>
			We are currently using PayPal as our payment medium. This is convenient for online payment and the only available one at the moment.<br/>
			In future, we sure will upgrade our payment methods for further convenience. 
		</p>	
	<br/>
<hr width="75%"	>
	<h2>Quick Info</h2>
